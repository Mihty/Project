...
public class priority1 extends BaseTest {
    ...
    public void testRemoveProductFromCart() {
        ...
        WebElement cartItem = driver.findElement(By.xpath("//div[contains(@class, 'flex-container')]"));
        WebElement removeButton = cartItem.findElement(By.xpath("//div[@class='icon-trash']"));
        removeButton.click();
